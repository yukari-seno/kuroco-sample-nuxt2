...
/***/ "./frontend/_es6/lib/accordion.js":
/*!****************************************!*\
  !*** ./frontend/_es6/lib/accordion.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _polyfill_CustomEvent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../polyfill/CustomEvent.js */ "./frontend/_es6/polyfill/CustomEvent.js");
/* harmony import */ var _polyfill_CustomEvent_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_polyfill_CustomEvent_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _polyfill_closest_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../polyfill/closest.js */ "./frontend/_es6/polyfill/closest.js");
/* harmony import */ var _polyfill_closest_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_polyfill_closest_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _slideToggle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slideToggle.js */ "./frontend/_es6/lib/slideToggle.js");
// Polyfill
...
var animeOption;
var accordionToggleOnClick = function accordionToggleOnClick(e) {
  e.preventDefault();
  var tg = e.currentTarget;
  var rel = tg.dataset.accordionToggle;
  var isActive = tg.classList.contains(classActive);
  var cts = rel === '' ? tg.parentNode.nextElementSibling : document.querySelector("[data-accordion-cts=\"".concat(rel, "\"]"));
  if (!cts) return;
  if (isActive) {
    tg.classList.remove(classActive);
    (0,_slideToggle_js__WEBPACK_IMPORTED_MODULE_2__.slideUp)(cts, animeOption);
    var event = new CustomEvent('accordion.close.complete');
    tg.dispatchEvent(event);
  } else {
    tg.classList.add(classActive);
    (0,_slideToggle_js__WEBPACK_IMPORTED_MODULE_2__.slideDown)(cts, animeOption);
    var _event = new CustomEvent('accordion.open.complete');
    tg.dispatchEvent(_event);
  }
};
var accordionToggleInit = function accordionToggleInit(el) {
  el.addEventListener('click', accordionToggleOnClick, false);
  if (animeOption.callback && animeOption.callback.open) {
    el.addEventListener('accordion.open.complete', animeOption.callback.open, false);
  }
  if (animeOption.callback && animeOption.callback.close) {
    el.addEventListener('accordion.close.complete', animeOption.callback.close, false);
  }
};
var accordion = function accordion() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-accordion-toggle]';
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var els = document.querySelectorAll(selector);
  animeOption = args;
  if (!els) return;
  Array.prototype.forEach.call(els, accordionToggleInit);
};


/***/ }),

/***/ "./frontend/_es6/lib/getElementHeight.js":
/*!***********************************************!*\
  !*** ./frontend/_es6/lib/getElementHeight.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var getElementHeight = function getElementHeight(el) {
  if (!el) return;
  var leCopy = el.cloneNode(true);

  // Radioボタンの場合値がクリアされるため、グルーピングを変える
  Array.from(leCopy.querySelectorAll('input'), function (i) {
    i.setAttribute("name", "clone_" + i.getAttribute("name"));
  });
  el.parentNode.appendChild(leCopy);
  leCopy.style.cssText = 'display:block; height:auto; max-height:none; visibility:hidden;';
  var copyH = leCopy.offsetHeight;
  el.parentNode.removeChild(leCopy);
  return copyH;
};
...
/***/ "./frontend/_es6/lib/slideToggle.js":
/*!******************************************!*\
  !*** ./frontend/_es6/lib/slideToggle.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _getElementHeight_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getElementHeight.js */ "./frontend/_es6/lib/getElementHeight.js");
// Polyfill
...
var slideUp = function slideUp(el) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var _opt = Object.assign({}, defaultOptions, args);
  _opt.height = "0px";
  _opt.targets = el;
  _opt.begin = function () {
  ...
  _opt.complete = function () {
    ...
    var event = new CustomEvent('slideup.complete');
    el.dispatchEvent(event);
  };
  (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(_opt);
};
var slideDown = function slideDown(el) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var _h = (0,_getElementHeight_js__WEBPACK_IMPORTED_MODULE_2__.getElementHeight)(el);
  var _opt = Object.assign({}, defaultOptions, args);
  _opt.height = "".concat(_h, "px");
  _opt.targets = el;
  _opt.begin = function () {
    el.style.display = 'block';
  };
  _opt.complete = function () {
    ...
    var event = new CustomEvent('slidedown.complete');
    el.dispatchEvent(event);
  };
  (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(_opt);
};
...
var tabChange = function tabChange(e) {
  ...
  var group = el.dataset.tabBtn;
  var tabs = document.querySelectorAll("[data-tab-btn=\"".concat(group, "\"]"));
  var rel = el.getAttribute('href').replace(/.*#/, '');
  var cts = document.querySelectorAll("[data-tab-cts=\"".concat(group, "\"]"));
  var tg = document.querySelector("#".concat(rel));
  var root = document.querySelector("[data-tab-root=\"".concat(group, "\"]"));
  root && root.setAttribute('data-tab-active', rel);
...
var tabBind = function tabBind(el) {
  var group = el.dataset.tabBtn;
  var tabs = document.querySelectorAll("[data-tab-btn=\"".concat(group, "\"]"));
  for (var i = 0, l = tabs.length; i < l; i++) {
    var tab = tabs[i];
...
var tabNav = function tabNav() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-tab-btn]';
...
/***/ "./frontend/_es6/modules/readmore.js":
/*!*******************************************!*\
  !*** ./frontend/_es6/modules/readmore.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _polyfill_closest_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../polyfill/closest.js */ "./frontend/_es6/polyfill/closest.js");
/* harmony import */ var _polyfill_closest_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_polyfill_closest_js__WEBPACK_IMPORTED_MODULE_0__);
// Polyfill

var classActive = 'is-open';
var evClick = function evClick(e) {
  e.preventDefault();
  var el = e.currentTarget;
  var rel = el.dataset.readmoreToggle;
  var tg = document.querySelector("[data-readmore-cts=\"".concat(rel, "\"]"));
  el.classList.add(classActive);
  tg.classList.add(classActive);
};
var readmoreInit = function readmoreInit(el) {
  var rel = el.dataset.readmoreToggle;
  el.addEventListener('click', evClick, false);
};
var readmore = function readmore() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-readmore-toggle]';
  var els = Array.prototype.slice.call(document.querySelectorAll(selector));
  for (var i = 0, l = els.length; i < l; i++) {
    var el = els[i];
    readmoreInit(el);
...
/***/ "./frontend/_es6/polyfill/CustomEvent.js":
/*!***********************************************!*\
  !*** ./frontend/_es6/polyfill/CustomEvent.js ***!
  \***********************************************/
/***/ (() => {
...
/***/ "./frontend/_es6/polyfill/closest.js":
/*!*******************************************!*\
  !*** ./frontend/_es6/polyfill/closest.js ***!
  \*******************************************/
/***/ (() => {
...
"use strict";
/*!*******************************************!*\
  !*** ./frontend/htdocs/assets/js/top.mjs ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _es6_lib_accordion_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../_es6/lib/accordion.js */ "./frontend/_es6/lib/accordion.js");
/* harmony import */ var _es6_modules_readmore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../_es6/modules/readmore.js */ "./frontend/_es6/modules/readmore.js");
/* harmony import */ var _es6_lib_tabNav_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../_es6/lib/tabNav.js */ "./frontend/_es6/lib/tabNav.js");
//--------------------------------------------------
// lib
//--------------------------------------------------
